        ...
        <div className=' mx-28 my-20'>
          <div className=''>
            ...
            <div className=''>
              ...
              {/* content card */}
              <div className='mt-12'>
                <div className='flex items-ceter justify-between flex-wrap'>
                  <BrowseCourseCard
                  ...
                  <BrowseCourseCard
                    ...
                    title='Photoshop Basice to Expart'
                    courses='25 courses'
                  />
                  <BrowseCourseCard
                    icon={<BiMinusFront />}
...
const BrowseCourseCard = ({ icon, title, courses }) => {
  return (
    <>
      <div className='w-64 h-auto cursor-pointer group bg-white hover:bg-[#1eb2a6] shadow hover:shadow-none rounded-sm px-4 py-4 transition ease-linear duration-500 mt-5'>
