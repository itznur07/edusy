        ...
        <div className='mx-24'>
          <div className='flex items-center justify-between space-x-24 py-6'>
            ...
            <div className='space-x-6 text-md cursor-pointer'>
              <span className='bg-[#fff] hover:bg-[#1EB2A6] bg-opacity-30 hover:text-white text-[#1EB2A6] px-4 py-2.5 rounded-full '>
                <i class='fa-brands fa-facebook-f'></i>
              </span>
              <span className='bg-[#fff] hover:bg-[#1EB2A6] bg-opacity-30 hover:text-white text-[#1EB2A6] px-4 py-3 rounded-full '>
